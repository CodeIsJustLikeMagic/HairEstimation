...
Knielange dunkelblonde Haare wurden auf weißem Hintergrund aufgenommen. 
FIGURE  unterschiedliche bilder mit unterschieldichen mengen.

Mit diensen haaren wurde über 3? wochen eine Untersuchung von tägloichem haarausfall angestellt. 
FIGURE graph pro tag

Um die Fehlerrate zu testen wurde für einige der eingage Bilder die Anzahl der Haare per Hand gezählt.
So entsteht konnten die folgenden Fehler in den schätzungen vermerkt werden. 
ERGEBNISS VON calculateError reintun.

\subsection{Test: Hüftlange, feine, blonde Haare}

Blonde Haare wurden vor einem Schwarzen Hintergrund aufgenommen. 
FIGURE input.
Der scharze Hintergrund 
